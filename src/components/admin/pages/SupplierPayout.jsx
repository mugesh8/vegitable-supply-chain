  ...
  const payouts = [
    {
      id: 'ORD-2024-1294',
      supplierId: 'GF',
      supplierBg: 'bg-[#C8F4E8]',
      supplierName: 'Green Fields Farm',
      vendorId: 'VEN-001',
    ...
    },
    {
      id: 'ORD-2024-1293',
      supplierId: 'FV',
      supplierBg: 'bg-[#E0E8FF]',
      supplierName: 'Fresh Vegetable Supply Co.',
      vendorId: 'VEN-002',
    ...
    },
    {
      ...
      supplierId: 'OV',
      supplierBg: 'bg-[#E0E8FF]',
      supplierName: 'Organic Valley Farmers',
      vendorId: 'VEN-003',
    ...
    },
    {
      id: 'ORD-2024-1291',
      supplierId: 'AL',
      supplierBg: 'bg-[#FFE0E0]',
      supplierName: 'Agri Logistics Partners',
      vendorId: 'VEN-004',
    ...
    },
    {
      id: 'ORD-2024-1289',
      supplierId: 'HS',
      supplierBg: 'bg-[#FFF4CC]',
      supplierName: 'Harvest Supply Chain',
      vendorId: 'VEN-006',
              ...
              <tbody>
                {payouts.map((payout, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-[#0D5C4D]">{payout.supplierName}</div>
